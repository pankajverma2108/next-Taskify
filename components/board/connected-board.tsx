...
export function ConnectedBoard({ initial }: { initial: BoardData }) {
  ...
  return <BoardWorkspace initial={initial} mutate={mutate} refresh={refresh} options={<BoardOptions id={initial.id} />} />;
}
